...
function aiDraftContent(topic){var p='You are the AI Operating Partner for HKS Law, Kitchener-Waterloo Ontario. Write a professional LinkedIn/Google Business post about: '+topic+'. Educational (not promotional), under 200 words, subtle CTA, LSO compliant, no superlatives, no outcome promises. Position HKS Law as the local KW expert.';window.open('https://claude.ai/new?q='+encodeURIComponent(p),'_blank');toast('Content sent to Claude.ai!');}
