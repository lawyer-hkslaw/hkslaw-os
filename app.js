...
');
  try{
    ...
    window._csv=csvBody;
    var modalBody='<div style="font-size:13px;color:var(--text2);margin-bottom:10px;">Copy the data below and paste into your Google Sheet.</div><textarea id="csvbox" style="height:120px;font-family:monospace;font-size:11px;" readonly>'+csvBody+'</textarea>';
    var modalFoot='<button class="btn btn-ghost" onclick="closeModal()">Close</button><button class="btn btn-gold" onclick="var b=document.getElementById(\'csvbox\');b.select();document.execCommand(\'copy\');toast(\'Copied!\')">Copy Data</button>';
    openModal('Export to Google Sheets',modalBody,modalFoot);
  }
}
...
const PLAYBOOK_DATA = {
  intake:[
    {q:"How much does a real estate lawyer cost?",a:"Our fees depend on the type and complexity of the transaction. We offer clear, upfront fixed fees for most real estate matters — no surprises. If you'd like a quote, I can take down a few details and have [LAWYER] get back to you with an exact number, usually within the hour. Would that work?"},
    {q:"Can I speak to the lawyer right now?",a:"[LAWYER] is currently in a meeting / with a client / reviewing files. I can take all your information right now, and [LAWYER] will personally follow up with you by [TIME]. Alternatively, if you'd like to book a consultation directly, I can get you on the calendar for [DATE OPTIONS]. What works best for you?"},
    {q:"How long will my matter take?",a:"That really depends on the specifics, which [LAWYER] would be best to answer for your situation. What I can tell you is that we aim to be responsive and proactive — we don't let files sit. Can I get your details so [LAWYER] can give you a real timeline?"},
    ...
    {q:"I got a better quote from another lawyer",a:"I understand — it's smart to compare. I'd encourage you to think not just about the number, but about communication speed and reliability, especially for something like a real estate closing. Can I take your details and ask [LAWYER] to personally call you back? [LAWYER] may be able to speak to the value we bring."},
    ...
    {q:"Is [LAWYER] licensed?",a:"Absolutely. [LAWYER] is a licensed Ontario lawyer in good standing with the Law Society of Ontario. You can verify the licence at lso.ca. Is there anything specific about the firm's background I can share?"},
  ...
  re:[
    {q:"What's the closing date? Is it confirmed?",a:"The closing date that [LAWYER] is working toward is [DATE], as per the agreement. If anything changes with the date, the lawyer and your real estate agent will confirm. Is there a specific concern about the timeline?"},
    {q:"When do I get the keys?",a:"The keys are typically released after the transaction closes and funds are confirmed — usually by [TIME] on closing day. [LAWYER] will update you the morning of closing with timing. I'll make a note for [LAWYER] to confirm this with you."},
    {q:"Why do I need title insurance?",a:"Title insurance protects you against issues that might not show up in a title search — things like survey errors, unknown liens, or fraud. [LAWYER] recommends it on all residential purchases. I'll make a note that you'd like [LAWYER] to explain this in more detail — they can walk you through it at signing."},
    {q:"What documents do I need to bring?",a:"I'll send you the full list right now by email. Generally you'll need two pieces of ID and your mortgage instructions if applicable. I'll send the complete checklist to [EMAIL] — does that work?"},
    {q:"Can we move the closing date?",a:"Any changes to the closing date need to go through your real estate agent and the other side's lawyer — [LAWYER] can advise on whether that's feasible once I flag this. Can I ask what's coming up that might require a change? I'll escalate to [LAWYER] right away."},
  ],
  immigration:[
    {q:"How long will my application take?",a:"Processing times vary and change frequently with IRCC. [LAWYER] will give you the most current estimate based on your specific application type and circumstances. I'll note that you'd like an updated timeline — [LAWYER] will address this."},
    {q:"Is my application guaranteed to be approved?",a:"I can't speak to the outcome — that's something [LAWYER] will be careful not to promise either, because every application depends on IRCC's assessment. What I can say is that [LAWYER] ensures every application is as strong as possible before it's submitted."},
    {q:"I got a letter from IRCC — what does it mean?",a:"Please send a photo or scan of that letter to [EMAIL] right away — I'll flag it as URGENT for [LAWYER] to review. Don't take any action until you hear back."},
    {q:"Can I work while my application is in progress?",a:"That depends on your specific situation and permit type — this is a legal question that [LAWYER] needs to answer. I'll flag this for [LAWYER] to call you back today. Please don't make any assumptions about your work authorization until you hear from [LAWYER]."},
  ],
  lt:[
    {q:"What happens at the LTB hearing?",a:"[LAWYER] will walk you through exactly what to expect before your hearing date. Generally both sides present their position and evidence to the adjudicator. I'll make a note for [LAWYER] to schedule a hearing prep call with you — we recommend doing this at least a week before."},
    ...
    {q:"My tenant hasn't paid rent — what do I do?",a:"You may need to serve an N4 Notice to End Tenancy for Non-Payment of Rent — but the exact form and timing matters. Let me take your details and flag this for [LAWYER] to call you back today with the next steps."},
  ],
  insurance:[
    {q:"The insurance company denied my claim — can you help?",a:"Absolutely — that's a core part of what [LAWYER] does. Denial doesn't mean it's over. Can I get your policy number, insurer name, and the date of the denial? [LAWYER] will review and advise on whether you have grounds to challenge."},
    {q:"How long do I have to dispute?",a:"There are limitation deadlines that can be as short as one year from the date of loss under some Ontario policies — this is urgent. I'm flagging this as URGENT for [LAWYER] to call you back today. Do not wait."},
    {q:"How much will this cost me?",a:"[LAWYER] will go over fee structures — including whether a contingency arrangement makes sense for your case. That conversation needs to happen directly with [LAWYER]. I'll book you in right away."},
  ],
  objections:[
    {q:"I'll think about it",a:"Absolutely — this is an important decision. Can I ask, is there a specific concern I can help address? Or is there any information about how we work that would help you decide? I can also have [LAWYER] give you a quick call — no obligation, just a conversation."},
    {q:"You're more expensive than another firm",a:"I understand. Price matters. What I'd encourage you to think about is what a delayed closing or a missed immigration deadline costs — and whether the firm you're comparing us to has the same responsiveness and communication standards. Can I have [LAWYER] call you to talk through what's included in our fee?"},
    {q:"I already have a lawyer",a:"Of course — that's great. If anything changes, or if you ever need a second opinion or have a matter outside your current lawyer's focus area, please don't hesitate to reach out. Can I take your contact info in case we can help in the future?"},
    {q:"I don't need a lawyer for this",a:"That's absolutely your right, and I won't push. What I can tell you is that [LAWYER] often sees clients later in a matter who wish they had gotten advice earlier — especially in real estate, immigration, and insurance. The call is free. Want me to book you for 15 minutes with [LAWYER], no charge?"},
    {q:"How do I know you're trustworthy?",a:"Fair question. [LAWYER] is licensed by the Law Society of Ontario — you can verify at lso.ca right now. We also have [X] Google reviews at [LINK]. And every client engagement starts with a written retainer agreement, so everything is on paper before any work begins."},
  ],
  difficult:[
    {q:"Client is very angry or threatening",a:"ESCALATE IMMEDIATELY to [LAWYER]. Say: 'I understand you're very frustrated and I want to make sure [LAWYER] addresses this personally. I'm going to get [LAWYER] on the line right now / have [LAWYER] call you back within 15 minutes.' Do NOT engage with the substance of the complaint."},
    ...
    {q:"Client asks for legal advice directly from staff",a:"'I want to make sure you get the right answer — that's something [LAWYER] needs to address directly. I'm going to send [LAWYER] a message right now. [LAWYER] will follow up with you by [TIME] today.' Never guess, never try to answer, never say what you think the law is."},
    {q:"Someone requests confidential file information",a:"'I'm not able to share file information without direction from [LAWYER]. Can I have [LAWYER] call you back? I'll flag this as urgent.' Verify identity before confirming any file details even to clients — impersonation is a LAWPRO risk."},
  ]
};
...
function renderDash(){
  ...
  document.getElementById('dash-tasks').innerHTML=urgent.length?urgent.map(t=>taskHTML(t,true)).join(''):'<div class="muted" style="padding:12px 0;">No urgent tasks — you\'re on track! 🎉</div>';
...
const GROWTH_CONTENT={
  ...
  networking:`<div class="grid-2 mb14">
    ...
    <div class="card">
      ...
      <div class="ai-response">"I'm [LAWYER] — I run HKS Law in Kitchener. We focus on real estate, immigration, and landlord-tenant matters. What makes us different is we answer within 4 hours and we're known for never surprising clients with delays on closing day. If you ever have a client who needs a lawyer they can actually reach — that's us."</div>
      <div class="card-title mt12">📌 What Realtors Actually Care About</div>
      ${['Speed — they need to know you won't blow a closing date','Communication — they hate chasing lawyers for updates','Flexibility — digital signing, evening availability for clients','Reliability — same result every time, no drama'].map(t=>`<div style="font-size:12px;color:var(--text2);padding:7px 0;border-bottom:1px solid var(--border);">✓ ${t}</div>`).join('')}
    </div>
  </div>`,
...
const MK={
  ...
  content:`<div class="card mb14">
    ...
    <div class="grid-3">
      ${[
        ...
        {week:'Week 2',type:'Education',topic:'Your work permit is expiring — here\'s what to do',channel:'Google Business + LinkedIn'},
        ...
        {week:'Week 4',type:'Personal',topic:'Behind the scenes at HKS Law — what we\'re working on',channel:'LinkedIn'},
  ...
  ads:`<div class="grid-2 mb14">
    <div class="card">
      ...
      ${[
        {t:'When to start','After you have a Google Business profile, 15+ reviews, and a clear intake process. Starting ads before fixing conversion = burning money.'},
        {t:'Budget to start','$500–800/month for KW market. Real estate lawyer CPCs are $15–40. Target 20–30 clicks/month at start.'},
        {t:'Top keywords to bid on','real estate lawyer kitchener, immigration lawyer waterloo, LTB lawyer ontario, landlord tenant lawyer KW'},
        {t:'Landing page requirement','Ads must go to a specific page — not homepage. One service, one CTA, clear price or "get a free quote".'},
        {t:'LSO advertising rules','Must include "Licensed by the Law Society of Ontario" — cannot use superlatives like "best" or "top" without substantiation.'},
...
function renderReferral(){
  ...
  document.getElementById('outreach-scripts').innerHTML=[
    {t:'Realtor Cold Call',type:'📞',s:`"Hi [NAME], this is [LAWYER] from HKS Law in Kitchener. I specialize in real estate closings and I'm calling a handful of top agents in the area. I know a solid closing lawyer makes your life easier — do you have 2 minutes to hear what I offer my realtor partners?"`},
    ...
    {t:'Immigration Consultant Email',type:'📧',s:`Hi [NAME], I'm [LAWYER] at HKS Law. I handle immigration legal matters — refusals, inadmissibility, complex sponsorship. I know consultants sometimes need a lawyer for cases outside their scope. Happy to be that resource for you. Can we connect for 15 minutes?`},
...
function renderPlaybook(key='intake'){
  ...
  document.getElementById('playbook-content').innerHTML=`
    <div style="background:var(--surface3);border:1px solid var(--gold-border);border-radius:var(--radius);padding:12px 16px;margin-bottom:16px;font-size:12px;color:var(--amber);">
      ⚖️ <strong>Critical Rule:</strong> Staff NEVER gives legal advice. If unsure, say: <em>"That's a great question — let me make sure [LAWYER] gives you the right answer. I'll have [LAWYER] call you back by [TIME] today."</em>
    </div>
...
My name is [LAWYER] and I'm the principal lawyer at HKS Law in Kitchener. I work exclusively in real estate law and reach out to a small number of realtors each year who I think would make strong partners.

What I offer your clients that most lawyers don't:
...
I've built my practice on the idea that a delayed or unresponsive lawyer costs you clients. I won't be that lawyer.
...
I'd love to send you our one-page firm overview — it covers response times, fee structures, and how we handle same-day requests. Would that be useful?

[LAWYER NAME]
HKS Law · hkslaw.ca`},
  'mortgage-intro':{s:'Partnership Opportunity — Real Estate Closings | HKS Law',b:`Hi [NAME],

I'm [LAWYER] at HKS Law in Kitchener-Waterloo. I specialize in residential and commercial real estate closings and wanted to reach out directly.
...
I work with a small number of trusted mortgage brokers. I'd value a short conversation if you're open to it.
...
I'd like to set up a brief consultation — usually 20 to 30 minutes — to hear your situation and give you an honest assessment of how we can help.

You can book directly here: [BOOKING LINK]
Or call us: [PHONE]

We're typically available [DAYS/HOURS].
...
I'm following up on your recent inquiry to HKS Law. I want to make sure this didn't fall through the cracks.

If your situation is time-sensitive, please call us directly at [PHONE] — we pick up.

If the timing isn't right or your needs have changed, that's completely fine. Just let us know.
...
If you've found assistance elsewhere, I'm glad — that's what matters most.

If you'd like to connect in the future, HKS Law is always here. We'd love the chance to help.
...
We're glad to have you as a client of HKS Law. This email confirms that your file is now open and [LAWYER NAME] is working on your matter.
...
THIS WEEK:
[TASK LIST — delete and replace with current week's priorities]
...
COMPLIANCE:
You are supervised by [LAWYER NAME] under LSO Rule 5.1. Your conduct reflects on the firm's licence. When in doubt, escalate.
...
function connectGmail(){
  openModal('Connect Gmail','<div style="text-align:center;padding:20px 0;"><div style="font-size:36px;margin-bottom:12px;">📧</div><div style="font-size:14px;font-weight:500;margin-bottom:8px;">Gmail OAuth 2.0 Connection</div><div style="font-size:12px;color:var(--text2);margin-bottom:16px;line-height:1.6;">Scopes: gmail.readonly + gmail.compose<br/>No email stored externally. LAWPRO privacy compliant.</div><div style="background:var(--amber-bg);border:1px solid rgba(232,168,76,.3);border-radius:var(--radius);padding:10px;font-size:11.5px;color:var(--amber);margin-bottom:16px;">Deploy this app to your domain with Google OAuth credentials for live Gmail access. Or use Demo Mode below.</div></div>',
  '<button class="btn btn-ghost" onclick="closeModal()">Close</button><button class="btn btn-gold" onclick="simGmail()">Demo Mode</button>');
}
function simGmail(){
  closeModal();
